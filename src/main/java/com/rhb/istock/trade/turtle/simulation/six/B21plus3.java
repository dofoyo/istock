...
public class B21plus3 {
	...
	public B21plus3(BigDecimal initCash, Integer type) {
...
/*				//大盘不好,有赚就卖
	...
	private List<Muster> getBreakers(Map<String,Muster> ms,List<Map<String,Muster>> previous, Integer sseiRatio, Set<String> holds, Set<String> oks){
