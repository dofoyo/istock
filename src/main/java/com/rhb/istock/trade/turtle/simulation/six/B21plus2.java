...
/*				//大盘不好,有赚就卖
		...
		//if(sseiFlag==1) {
			...
			//确定突破走势的股票
			List<Muster> breakers = this.getBreakers(new ArrayList<Muster>(musters.values()), previous, sseiRatio,holdItemIDs, oks);
	...
	private List<Muster> getBreakers(List<Muster> musters,List<Map<String,Muster>> previous, Integer sseiRatio, Set<String> holds, Set<String> oks){
