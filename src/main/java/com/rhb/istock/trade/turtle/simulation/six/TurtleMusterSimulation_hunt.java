...
@Service("turtleMusterSimulation_hunt")
public class TurtleMusterSimulation_hunt {
	protected static final Logger logger = LoggerFactory.getLogger(TurtleMusterSimulation_hunt.class);
