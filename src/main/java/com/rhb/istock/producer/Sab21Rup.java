...
@Service("sab21Rup")
public class Sab21Rup implements Producer{
	protected static final Logger logger = LoggerFactory.getLogger(Sab21Rup.class);
	...
	private String fileName  = "Sab21Rup.txt";
