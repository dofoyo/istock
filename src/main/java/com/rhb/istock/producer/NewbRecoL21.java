...
@Service("newbRecoL21")
public class NewbRecoL21 implements Producer{
	protected static final Logger logger = LoggerFactory.getLogger(NewbRecoL21.class);
	...
	private String fileName  = "NewbRecoL21.txt";
