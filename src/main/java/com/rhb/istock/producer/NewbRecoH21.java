...
@Service("newbRecoH21")
public class NewbRecoH21 implements Producer{
	protected static final Logger logger = LoggerFactory.getLogger(NewbRecoH21.class);
	...
	private String fileName  = "NewbRecoH21.txt";
