...
@Service("drumRecoL21")
public class DrumRecoL21 implements Producer{
	protected static final Logger logger = LoggerFactory.getLogger(DrumRecoL21.class);
	...
	private String fileName  = "DrumRecoL21.txt";
