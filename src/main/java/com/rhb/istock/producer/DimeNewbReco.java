...
@Service("dimeNewbReco")
public class DimeNewbReco implements Producer{
	protected static final Logger logger = LoggerFactory.getLogger(DimeNewbReco.class);
	@Autowired
	...
	private String fileName  = "DimeNewbReco.txt";
