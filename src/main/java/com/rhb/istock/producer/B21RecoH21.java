...
@Service("b21RecoH21")
public class B21RecoH21 implements Producer{
	protected static final Logger logger = LoggerFactory.getLogger(B21RecoH21.class);
	...
	private String fileName  = "B21RecoH21.txt";
