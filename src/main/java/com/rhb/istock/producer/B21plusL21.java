...
@Service("b21plusL21")
public class B21plusL21 implements Producer{
	protected static final Logger logger = LoggerFactory.getLogger(B21plusL21.class);
	...
	private String fileName  = "B21plusL21.txt";
