...
@Service("sabRecoH21_34")
public class SabRecoH21_34 implements Producer{
	protected static final Logger logger = LoggerFactory.getLogger(SabRecoH21_34.class);
	...
	private String fileName  = "SabRecoH21_34.txt";
	private Integer pool = 21;
	private Integer period = 34;
